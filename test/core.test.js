...
import { detectKind, detectMime } from "../src/kinds.js";
import { slugify } from "../src/registry.js";
import { parseCsv } from "../src/render.js";
...
test("registry publish, revisions, conflicts, listing", () => {
  ...
  // generated slug collision gets a unique suffix instead of a conflict
